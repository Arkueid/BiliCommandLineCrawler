...
from .source import get_videos_audios
...
class Episode:
    ...
    def __init__(self, collection: str, title: str, cover: str, BV: str, p: int | None):
        self.__height = None
        ...
        self.__BV = BV
        self.__p = p
        page = get_page_by_bv(self.__BV, p=self.__p, cookie=Variables.COOKIE)
